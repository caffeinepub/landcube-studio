export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed right-0 top-1/2 -translate-y-1/2 z-50 flex items-center gap-2 px-3 py-3 rounded-l-xl shadow-lg transition-all hover:px-5 active:scale-95 group"
    ...
    >
      ...
      <span className="text-white text-sm font-medium overflow-hidden max-w-0 group-hover:max-w-xs transition-all duration-300 whitespace-nowrap">
        WhatsApp
      </span>
    </a>
  );
